import type { StatsDayDTO, StatsDTO } from './dto/stats.js';
import { hasRealActivity } from './what-changed.js';
...
// Money formatting lives in money.ts — re-exported here so Progress
// components import their helpers from one place.
export { formatMinorCompact } from './money.js';
